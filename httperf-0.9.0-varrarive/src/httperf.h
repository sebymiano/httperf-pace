...
{
    u_int64_t  num_conns;  /* number of connections to use this distribution for */
...
typedef struct Cmdline_Params
{
    ...
    u_int64_t  num_rates;              /* number of rates */
    Rate_Info rates[NUM_RATES];
